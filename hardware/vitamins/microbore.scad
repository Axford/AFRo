...
module microborePipe(l=100, od=10, id=8) {
	...
	if ($children > 0) {
		translate([0,0,l]) children(0);
	
		if ($children > 1) rotate([0,180,0]) children(1);
	}
}
...
module microboreT(od=10) {
	...
	if ($children > 0) {
		rotate([0,90,0]) translate([0,0,15]) children(0);
	
		if ($children > 1) translate([0,0,l]) children(1);
		if ($children > 2) rotate([0,-90,0]) translate([0,0,15]) children(2);
	}
}
...
module microboreElbow(od=10) {
	...
	if ($children > 0) {
		translate([1.5 * od,0,1.5*od]) rotate([0,90,0]) children(0);
