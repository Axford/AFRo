	...
	difference()
	 {
		...
		difference()
			...
			if ( belt_type == "XL" ) { XL(pulley_t_ht);}
			if ( belt_type == "H" ) { H(pulley_t_ht);}
			if ( belt_type == "T2.5" ) { T2_5(pulley_t_ht);}
			if ( belt_type == "T5" ) { T5(pulley_t_ht);}
			if ( belt_type == "T10" ) { T10(pulley_t_ht);}
			if ( belt_type == "AT5" ) { AT5(pulley_t_ht);}
			if ( belt_type == "HTD_3mm" ) { HTD_3mm(pulley_t_ht);}
			if ( belt_type == "HTD_5mm" ) { HTD_5mm(pulley_t_ht);}
			if ( belt_type == "HTD_8mm" ) { HTD_8mm(pulley_t_ht);}
			if ( belt_type == "GT2_2mm" ) { GT2_2mm(pulley_t_ht);}
			if ( belt_type == "GT2_3mm" ) { GT2_3mm(pulley_t_ht);}
			if ( belt_type == "GT2_5mm" ) { GT2_5mm(pulley_t_ht);}
			}
